        ...
        <div class="card-body login-card-body">
          ...
          <form action="<?php echo e(route('login.process')); ?>" method="post">
            ...
            <div class="input-group mb-3">
              <input id="loginEmail" name="email" type="email" class="form-control" placeholder="Email"  value="<?php echo e(old('email')); ?>" required/>
...
<?php /**PATH C:\laragon\www\hrd\resources\views/auth/login.blade.php ENDPATH**/ ?>